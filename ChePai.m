...
close all
clc
[fn,pn,fi]=uigetfile('ChePai\*.jpg','选择图片');
...
for i=1:6
    ...
    figure(4);subplot(1,7,8-i);imshow(ChePaiFenGe);
    ii=int2str(8-i);
...
HanZi=DuQuHanZi(imread('MuBanKu\sichuan.bmp'),imread('MuBanKu\guizhou.bmp'),imread('MuBanKu\beijing.bmp'),imread('MuBanKu\chongqing.bmp'),...
                imread('MuBanKu\guangdong.bmp'),imread('MuBanKu\shandong.bmp'),imread('MuBanKu\image2.jpg'));
